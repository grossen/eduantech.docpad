var ADAPT_CONFIG={path:"/styles/",dynamic:!0,range:["0 to 640 = unsemantic-grid-mobile.css","641 to 1024 = unsemantic-grid-tablet.css","1025 = unsemantic-grid-desktop.css"]};
